========================================================================
    KONSOLENANWENDUNG: ExpiryFile_oop-Projektübersicht
========================================================================

Diese ExpiryFile_oop-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre ExpiryFile_oop-Anwendung besteht.


ExpiryFile_oop.vcxproj
...
ExpiryFile_oop.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen ExpiryFile_oop.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
